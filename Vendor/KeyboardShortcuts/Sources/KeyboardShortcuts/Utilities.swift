...
extension String {
	...
	*/
	var localized: String {
		let resourceURL = Bundle.main.resourceURL?.appendingPathComponent("KeyboardShortcuts_KeyboardShortcuts.bundle")
        let packagedBundle = resourceURL.flatMap { Bundle(url: $0) }
